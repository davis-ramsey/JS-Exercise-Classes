...
class Instructor extends Lambdasian {
	...
	changeGrade(student) {
		...
		if (randNum > 0.5) student.grade += 10;
		else student.grade -= 5;
	}
}
...
class Student extends Lambdasian {
	...
	graduate() {
		...
		else return `${this.name} needs more grading!!`;
	}
}
...
const Zoe = new Instructor({ name: 'Zoe' });

console.log(davis.graduate());
Zoe.grade(davis);
Zoe.grade(davis);
Zoe.grade(davis);
Zoe.grade(davis);
